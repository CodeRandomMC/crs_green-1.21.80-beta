    ...
    static tryFertilize(block, player, itemStack, params) {
        ...
        if (player.getGameMode() === GameMode.creative) {
            ...
            if (itemStack.amount > 1) {
                itemStack.amount--;
                (_a = PlayerUtils.getEquipmentSlot(player, EquipmentSlot.Mainhand)) === null || _a === void 0 ? void 0 : _a.setItem(itemStack);
            }
            else {
                (_b = PlayerUtils.getEquipmentSlot(player, EquipmentSlot.Mainhand)) === null || _b === void 0 ? void 0 : _b.setItem(undefined);
            }
        }
